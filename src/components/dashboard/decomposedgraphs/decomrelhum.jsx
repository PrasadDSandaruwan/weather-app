...
d3.csv("/decomposeddata3.csv", function (data1) {
    ...
    tempseasonal.push(data1.relative_humidity_trendseasonal);
    tempobserved.push(data1.relative_humidity_observed);
    temptrend.push(data1.relative_humidity_trend);

});



export default function DecomposedRelativeHumidityChart(props) {
