...
d3.csv("/decomposeddata3.csv", function (data1) {
    ...
    tempseasonal.push(data1.surface_solar_radiation_trendseasonal);
    tempobserved.push(data1.surface_solar_radiation_observed);
    temptrend.push(data1.surface_solar_radiation_trend);

});



export default function DecomposedSolarRadiationChart(props) {
