...
function HourlyAvergeTemperatureContent() {
                ...
                >
                    ...
                    <Grid item xs={12} md={12} lg={6}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={5}>
                            <Grid item>
                                <MainCard
                                    style={{ width: "600px", paddingRight: "1.5px", height: "250px", backgroundColor: "rgba(0, 0, 0, 0.4)" }}
                                    content={false}
                                    sx={{ mt: 2.5 }}
                                >
                            ...
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <WinterHourlyAvgTempChart year={year} />
                                </MainCard>
                            </Grid>
                        </Stack>
                        <Stack direction="row" alignItems="center" spacing={5}>
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <AutumnHourlyAvgTempChart year={year} />
                                </MainCard>
                            </Grid>
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <SpringHourlyAvgTempChart year={year} />
                                </MainCard>
                            </Grid>
                        </Stack>
                    </Grid>
...
export default function Dashboard() {
    return <HourlyAvergeTemperatureContent />;
}
