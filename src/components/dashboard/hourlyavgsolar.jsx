...
function HourlyAvergeSolarContent() {
                        ...
                        <Stack direction="row" alignItems="center" spacing={5}>
                            ...
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <WinterHourlyAvgSolarChart year={year} />
                                </MainCard>
                            </Grid>
                        </Stack>
                        <Stack direction="row" alignItems="center" spacing={5}>
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <AutumnHourlyAvgSolarChart year={year} />
                                </MainCard>
                            </Grid>
                            <Grid item>
                                <MainCard
                                    ...
                                    sx={{ mt: 2.5 }}
                                >
                                    <SpringHourlyAvgSolarChart year={year} />
                                </MainCard>
                            </Grid>
                        </Stack>
                    </Grid>
...
export default function Dashboard() {
    return <HourlyAvergeSolarContent />;
}
